...
public class MySQLBConnectionPoolForLocalHost_result {
	// log file
	private static final Logit log = Logit.getInstance(MySQLBConnectionPoolForLocalHost_result.class);

	// properties name
	private static final String CONFIG_FILE_NAME = "zhy_twitter_result.properties";
	//private static final String CONFIG_FILE_NAME = "MySQL_admin_result.properties";
