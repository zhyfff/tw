...
public class MySQLBConnectionPoolForLocalHost_task {
	// log file
	private static final Logit log = Logit.getInstance(MySQLBConnectionPoolForLocalHost.class);

	// properties name
	private static final String CONFIG_FILE_NAME = "MySQL_zhy_shechipin.properties";
	//private static final String CONFIG_FILE_NAME = "MySQL_admin_task.properties";
